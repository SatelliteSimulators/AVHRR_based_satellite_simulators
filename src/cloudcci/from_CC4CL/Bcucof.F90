! Code adapted by Salomon.Eliasson@smhi.se
! From CC4CL http://proj.badc.rl.ac.uk/orac/wiki
!
!-------------------------------------------------------------------------------
! Name: Bcucof.F90
!
...
! ---------- Adapted by Salomon
   ...
   real(wp), dimension(16), intent(out) :: c

   ! Define local variables

   real(wp)                             :: a
   real(wp), dimension(16)              :: x
   real(wp), dimension(16,16)           :: wt
! ------------------
