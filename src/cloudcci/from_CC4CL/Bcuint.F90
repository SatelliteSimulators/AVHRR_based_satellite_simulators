!
! Adapted by Salomon.Eliasson@smhi.se
! Codes from CC4CL http://proj.badc.rl.ac.uk/orac/wiki
!
!
!-------------------------------------------------------------------------------
! Name: Bcuint.F90
...
!   use ECP_Constants_m !removed by Salomon Eliasson
  USE cosp_kinds,  ONLY: wp ! added by Salomon Eliasson

   implicit none

   ! Define arguments

! ---- Adapted by Salomon Eliasson
